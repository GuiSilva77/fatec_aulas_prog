...
// fun��o para encontrar ou a maior ou a menor idade de acordo com o sexo
...
//fun��o para calcular a media dos salarios
...
void reajuste(Funcionario *vetor, int tamanho)
{
  for (int i = 0; i <= tamanho; i++)
  {
    if (vetor[i].salario <= 1000)
    {
      ...
      // fiquei confuso sobre a parte do bonus m�rito, eu n�o sabia se era para somar
      // com o salario ouu n�o, na d�vida aqui est� o c�digo para adicionar no salario:
      // vetor[i].salario += vetor[i].bonus_merito;
    }
  }
}
//fun��o para mostrar os resultados
